...
(function($) {
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
            ...
            '       <select class="unselected" style="height: 155px; width: 100%; padding-bottom: 10px;" multiple></select>' +
            '   </div>' +
            ...
            '       <select class="selected" style="height: 155px; width: 100%; padding-bottom: 10px;" multiple></select>' +
            '   </div>');
    ...
    function createVerticalButtons(copyAllBtn) {
        return '   <div class="col-md-2 center-block" style="margin-top: ' + (copyAllBtn ? '80px' : '130px') +'">' +
            (copyAllBtn ? '       <button type="button" class="btn btn-default col-md-8 col-md-offset-2 atr" data-type="atr" style="margin-bottom: 5px;"><span class="glyphicon glyphicon-list"></span> <span class="glyphicon glyphicon-chevron-right"></span></button>' : '') +
            ...
            '       <button type="button" class="btn btn-default col-md-8 col-md-offset-2 stl" data-type="stl" style="margin-bottom: 5px;" disabled><span class="glyphicon glyphicon-chevron-left"></span></button>' +
            (copyAllBtn ? '       <button type="button" class="btn btn-default col-md-8 col-md-offset-2 atl" data-type="atl" style="margin-bottom: 5px;"><span class="glyphicon glyphicon-chevron-left"></span> <span class="glyphicon glyphicon-list"></span></button>' : '') +
            '   </div>';
    }
    ...
    $.fn.getSelected = function() {
        var values = [];
        $(parent + ' .selected').find("option").each(function() {
    ...
    $.fn.setSelected = function(keys) {
        var selected = $(parent + ' .selected');
        var unselected = $(parent + ' .unselected');

        unselected.find('option').each(function() {
            var option = $(this);
            if($.inArray(option.text(), keys) >= 0) {

...
public class ComponentServer {
    public static final String PACKAGE_PATH = ComponentServer.class.getPackage().getName().replace('.', '/');
    ...
    public static void main(String[] args) throws Exception {
        ...
        applicationContext.register(ComponentServerConfiguration.class);
